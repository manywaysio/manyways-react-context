      ...
      <div className="char-image-container node-insert">
        ...
        <div>
          ...
          <p>
            ...
            and service, having worked for A-list celebrities and designer fashion brands
            throughout her career. A connoisseur of the world's hidden gems,
            <strong> Charlotte</strong>
            designs escapes that cater to the discerning traveler's quest for authenticity
            and adventure.
          </p>
        </div>
      </div>
